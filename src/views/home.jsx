    ...
    fetch("/api/hotels/" + e, {
      ...
      .then((data) => {
        data.hotels.sort(function (a, b) {
          return (
            b.ratings / (b.numberofRatings - 1 ? b.numberofRatings - 1 : 1) -
            a.ratings / (a.numberofRatings - 1 > 0 ? a.numberofRatings - 1 : 1)
          );
        });
...
*/
    fetch("/api/city/dishes/" + e, {
      ...
      .then((response) => response.json())
      .then((data) => {
        data.dishes.sort(function (a, b) {
          return (
            b.ratings /
              (b.numberofRatings - 1 > 0 ? b.numberofRatings - 1 : 1) -
            a.ratings / (a.numberofRatings - 1 > 0 ? a.numberofRatings - 1 : 1)
          );
        });
    ...
    <div>
      ...
      >
        ...
        >
          ...
          <span
            style={{ fontSize: "1.5em", color: "#bfbfbf", textAlign: "center" }}
          >
            At home we serve the kind of food we know the story behind
          </span>
          <div
            style={{
              width: "70%",
          ...
          >
            ...
            >
              ...
              >
                {cityList.map((data) => {
                  return (
                    <option id={data._id} value={data._id} name={data.name}>
                      {data.name}
                    </option>
                  );
                })}
            ...
            >
              ...
              >
                <input
                  ...
                  placeholder="Enter any Restaurants, dish or cuisine"
                  onChange={(e) => {
                    e.preventDefault();
              ...
              {filtereddishes.length > 0 || filteredhotelsList.length > 0 ? (
                <div
                  className="options"
                  style={{
                    width: "100%",
      ...
      >
        {searchedData ? (
          <>
            {searchedData.dishes.length == 0 &&
            searchedData.hotels.length == 0 ? (
              <div
                style={{
                  display: "flex",
                  justifyContent: "center",
              ...
              >
                ...
                >
                  <img
                    style={{ height: "100px" }}
                    src={find}
                    alt="Find best hotels and dishes"
                  />
                  <p style={{ width: "200px" }}>
                    {" "}
                    FIND BEST HOTELS, DISHES AND ADD TO YOUR CART
                  </p>
                </div>
                <div
                  style={{
                ...
                >
                  <img
                    style={{ height: "100px" }}
                    src={location}
                    alt="Place at you order"
                  />
                  <p style={{ width: "200px" }}>
                    PLACE YOUR ORDER WITH YOUR ADDRESS
                  </p>
                </div>
                <div
                  style={{
                ...
                >
                  <img
                    style={{ height: "100px" }}
                    src={deliver}
                    alt="Get Delivered at very less time"
                  />
                  <p style={{ width: "200px" }}>
                    GET ORDER DELIVERED IN MINIMUM TIME AND ENJOY YOUR MEAL
                  </p>
                </div>
              </ul>
            </div>
