              ...
              >
                ...
                <button
                  ...
                  style={{
                    ...
                    paddingBottom: "0em",
                    border:
                      this.state.key === "Dish" ? "2px solid #efefef" : "none",
                    borderBottom:
                      this.state.key === "Dish" ? "none" : "2px solid #efefef",
                  }}
                  onClick={() => {
                ...
                <button
                  ...
                  style={{
                    ...
                    paddingBottom: "0em",
                    border:
                      this.state.key === "Order" ? "2px solid #efefef" : "none",
                    borderBottom:
                      this.state.key === "Order" ? "none" : "2px solid #efefef",
                  }}
                  onClick={() => {
