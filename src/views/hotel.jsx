      ...
      <div>
        ...
        >
          <div style={{ maxWidth: "1000px", width: "100%", padding: "2em" }}>
            ...
            >
              <button
                ...
                style={{
                  ...
                  padding: "1em",
                  paddingBottom: "0em",
                  border: state.key === "Dishes" ? "2px solid #efefef" : "none",
                  borderBottom:
                    state.key === "Dishes" ? "none" : "2px solid #efefef",
                }}
                onClick={() => {
                  setState({ key: "Dishes" });
                }}
              ...
              <button
                ...
                style={{
                  ...
                  paddingBottom: "0em",
                  border:
                    state.key === "Reviews" ? "2px solid #efefef" : "none",
                  borderBottom:
                    state.key === "Reviews" ? "none" : "2px solid #efefef",
                }}
                onClick={() => {
            ...
            <div
              style={{
                display: state.key === "Reviews" ? "" : "none",
                width: "95%",
              }}
            >
              <ReviewSection />
