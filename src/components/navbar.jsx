  ...
  render(){
      return (
        <nav style={{width:"100%",height:"4em",background:"var(--color1)",}}>
          ...
          {(false)?<><img  style={{margin:"1em"}} src="https://img.icons8.com/color/30/26e07f/test-account.png"/>Hello! Kundan
          ...
          <div className="smallDevice" style={{float:"right",marginRight:"1em",height:"100%",justifyContent:"center",alignItems:"center"}}>
            <img className='hamburgerOption' src="https://img.icons8.com/external-gradak-royyan-wijaya/24/ffffff/external-hamburger-menu-basic-interface-iii-gradak-royyan-wijaya.png" onClick={()=>this.setState({openHamburger:true})}/>
          </div>

          <div className="hamburger" style={{display:(this.state.openHamburger)?"flex":"none", backgroundColor:"rgba(0,0,0,0.4)",position:"fixed",width:"100%",height:"100%"}}>

            <div className="Links" style={{backgroundColor:"var(--color1)",maxWidth:"300px",minWidth:"300px",height:"100%"}}>
            <img src="https://img.icons8.com/ios-glyphs/30/ffffff/delete-sign.png" style={{float:"right",margin:"1em"}} onClick={()=>this.setState({openHamburger:false})}/>
